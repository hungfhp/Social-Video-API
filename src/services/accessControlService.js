...
ac.grant('viewer')
	...
	.execute('readAny').on('recommend')
	.execute('readAny').on('group')
	.execute('readAny').on('like')
	.execute('readAny').on('rate')
...
ac.grant('user').extend('viewer')
	...
	.execute('readOwn').on('recommend')
	.execute('createOwn').on('recommend')
	.execute('updateOwn').on('recommend')
	.execute('deleteOwn').on('recommend')
	...
	.execute('readOwn').on('rate')
	.execute('createOwn').on('rate')
	.execute('updateOwn').on('rate')
	.execute('deleteOwn').on('rate')
