...
var _logToFile = __webpack_require__(136);
...
var _accessControlService = __webpack_require__(125);
...
var _passportLocal = __webpack_require__(141);

var _passportFacebook = __webpack_require__(139);

var _passportJwt = __webpack_require__(140);
...
var _mongooseFloat = __webpack_require__(137);
...
var _likeModel = __webpack_require__(23);

var _likeModel2 = _interopRequireDefault(_likeModel);

var _memberModel = __webpack_require__(24);
...
var _bcryptNodejs = __webpack_require__(128);
...
var _regex = __webpack_require__(29);
...
var _recommendModel = __webpack_require__(103);
...
var _recommendUtil = __webpack_require__(105);
...
var _relationshipModel = __webpack_require__(107);
...
var _relationshipUtil = __webpack_require__(109);
...
var _voiceoverModel = __webpack_require__(123);
...
var _fileService = __webpack_require__(25);
...
var _multiparty = __webpack_require__(27);
...
var _morgan = __webpack_require__(138);

var _morgan2 = _interopRequireDefault(_morgan);

var _bodyParser = __webpack_require__(129);

var _bodyParser2 = _interopRequireDefault(_bodyParser);

var _compression = __webpack_require__(130);

var _compression2 = _interopRequireDefault(_compression);

var _helmet = __webpack_require__(134);
...
var _cors = __webpack_require__(132);

var _cors2 = _interopRequireDefault(_cors);

var _cookieParser = __webpack_require__(131);
...
var _followMovieUtil = __webpack_require__(69);
...
var _followUserModel = __webpack_require__(31);
...
var _followUserUtil = __webpack_require__(73);
...
var _followUserController = __webpack_require__(71);

var followUserController = _interopRequireWildcard(_followUserController);

var _followUserValidation = __webpack_require__(74);
...
var _genreModel = __webpack_require__(76);
...
var _genreUtil = __webpack_require__(78);

var util = _interopRequireWildcard(_genreUtil);

var _helper = __webpack_require__(1);

var _genres = __webpack_require__(50);
...
var _genreValidation = __webpack_require__(32);
...
var _genreController = __webpack_require__(75);
...
var _authService = __webpack_require__(16);
...
var _groupModel = __webpack_require__(33);
...
var _groupUtil = __webpack_require__(81);
...
var _groupController = __webpack_require__(79);

var groupController = _interopRequireWildcard(_groupController);

var _groupValidation = __webpack_require__(82);
...
var _likeUtil = __webpack_require__(85);
...
var _likeController = __webpack_require__(83);

var likeController = _interopRequireWildcard(_likeController);

var _likeValidation = __webpack_require__(86);
...
var _memberUtil = __webpack_require__(89);
...
var _memberController = __webpack_require__(87);

var memberController = _interopRequireWildcard(_memberController);

var _memberValidation = __webpack_require__(90);
...
var _movies = __webpack_require__(127);
...
var _movieController = __webpack_require__(91);

var movieController = _interopRequireWildcard(_movieController);

var _movieValidation = __webpack_require__(93);
...
var _voiceoverController = __webpack_require__(37);

var voiceoverController = _interopRequireWildcard(_voiceoverController);

var _recommendController = __webpack_require__(35);
...
var _postModel = __webpack_require__(95);
...
var _postUtil = __webpack_require__(97);
...
var _postValidation = __webpack_require__(34);
...
var _postController = __webpack_require__(94);
...
var _rateModel = __webpack_require__(99);
...
var _rateUtil = __webpack_require__(101);
...
var _rateController = __webpack_require__(98);

var rateController = _interopRequireWildcard(_rateController);

var _rateValidation = __webpack_require__(102);
...
var _recommendValidation = __webpack_require__(106);
...
var _relationshipController = __webpack_require__(36);

var relationshipController = _interopRequireWildcard(_relationshipController);

var _relationshipValidation = __webpack_require__(110);
...
var _subModel = __webpack_require__(112);
...
var _subUtil = __webpack_require__(114);
...
var _subController = __webpack_require__(111);

var subController = _interopRequireWildcard(_subController);

var _subValidation = __webpack_require__(115);
...
var _uploadController = __webpack_require__(116);

var uploadController = _interopRequireWildcard(_uploadController);

var _uploadValidation = __webpack_require__(118);
...
var _uploadMiddleware = __webpack_require__(52);
...
async function getMoviesOwn(req, res, next) {
	try {
		let _ref = await _movieModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { uploader: req.params.id }), req.parsedParams),
		    { docs } = _ref,
		    pagination = _objectWithoutProperties(_ref, ['docs']);
		res.movies = docs;
		res.pagination = pagination;
...
async function getMoviesLiked(req, res, next) {
	try {
		let _ref2 = await _likeModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { user: req.params.id }), req.parsedParams),
		    { docs } = _ref2,
		    pagination = _objectWithoutProperties(_ref2, ['docs']);
...
async function getMoviesFollowed(req, res, next) {
	try {
		let _ref3 = await _followMovieModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { user: req.params.id }), Object.assign({}, req.parsedParams, {
			populate: [{
				path: 'movie',
				model: 'Movie'
			}]
...
async function getGroupsOwn(req, res, next) {
	try {
		let _ref4 = await _groupModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { creator: req.params.id }), req.parsedParams),
		    { docs } = _ref4,
...
async function getGroupsStatus(req, res, next) {
	try {
		let _ref5 = await _memberModel2.default.paginate(Object.assign({}, req.parsedParams.filters, {
			user: req.params.id,
...
async function getFollowers(req, res, next) {
	try {
		let _ref6 = await _followUserModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { follow: req.params.id }), Object.assign({}, req.parsedParams, {
			populate: [{
				path: 'user',
				model: 'User'
			}]
...
async function getFollowed(req, res, next) {
	try {
		let _ref7 = await _followUserModel2.default.paginate(Object.assign({}, req.parsedParams.filters, { user: req.params.id }), Object.assign({}, req.parsedParams, {
			populate: [{
				path: 'follow',
				model: 'User'
			}]
...
async function getUsers(req, res, next) {
	try {
		let _ref8 = await _userModel2.default.paginate(Object.assign({}, req.parsedParams.filters), req.parsedParams),
		    { docs } = _ref8,
...
var _userController = __webpack_require__(119);
...
var _userValidation = __webpack_require__(122);
...
var _fb = __webpack_require__(133);
...
var _roleAcl = __webpack_require__(142);
...
ac.grant('viewer').execute('readAny').on('user', ['*', '!password']).execute('readAny').on('followMovie').execute('readAny').on('followUser').execute('readAny').on('relationship').execute('readAny').on('movie').execute('readAny').on('post').execute('readAny').on('recommend').execute('readAny').on('group').execute('readAny').on('like').execute('readAny').on('member');
